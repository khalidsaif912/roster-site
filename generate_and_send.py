...
<head>
  ...
  <style>
    ...
    * {{ box-sizing:border-box; }}
    ...
    .shiftFilterBtn:hover {{
      transform:translateY(-2px);
      box-shadow:0 6px 18px rgba(15,23,42,.12);
    }}
    .shiftFilterBtn.active {{
      border-color:currentColor;
      box-shadow:0 4px 14px rgba(15,23,42,.15);
      transform:translateY(0);
    }}
    .shiftFilterBtn.active::before {{
      content:'';
      position:absolute;
    ...
    .shiftFilterBtn .emoji {{ font-size:18px; }}
    .shiftFilterBtn .label {{ position:relative; z-index:1; }}
    
    /* ألوان الورديات */
    .shiftFilterBtn.morning {{ color:#f59e0b; }}
    .shiftFilterBtn.afternoon {{ color:#f97316; }}
    .shiftFilterBtn.night {{ color:#8b5cf6; }}
    
    @media (max-width:480px){{
      .shiftFilterBar {{ gap:6px; }}
      .shiftFilterBtn {{ padding:10px 12px; font-size:13px; }}
      .shiftFilterBtn .emoji {{ font-size:16px; }}
    }}
...
<div class="wrap">
  ...
  <div class="shiftFilterBar">
    <button class="shiftFilterBtn morning active" data-shift="Morning">
      <span class="emoji">☀️</span>
      <span class="label">Morning</span>
    </button>
    <button class="shiftFilterBtn afternoon" data-shift="Afternoon">
      <span class="emoji">🌤️</span>
      <span class="label">Afternoon</span>
    </button>
    <button class="shiftFilterBtn night" data-shift="Night">
