...
/* ─── LIGHT THEME ─── */
body.light{{
  --bg:#f0f4fc;--surface:rgba(255,255,255,.85);--surface2:rgba(255,255,255,.95);
  --border:rgba(29,78,216,.1);--border2:rgba(29,78,216,.18);
  --ink:#0f172a;--muted:#4b5a7a;--dim:#94a3b8;
  --accent:#1d4ed8;--accent2:#7c3aed;--green:#059669;
  background-image:
    radial-gradient(ellipse 80% 50% at 20% -10%,rgba(59,130,246,.12) 0%,transparent 60%),
    radial-gradient(ellipse 60% 40% at 80% 110%,rgba(124,58,237,.08) 0%,transparent 55%),
    radial-gradient(ellipse 40% 30% at 60% 40%,rgba(5,150,105,.05) 0%,transparent 50%);
  background-color:#f0f4fc;
}}
body.light .dept-card{{
  background:rgba(255,255,255,.82);border-color:rgba(29,78,216,.1);
  box-shadow:0 4px 24px rgba(29,78,216,.08),inset 0 1px 0 rgba(255,255,255,.9);
}}
body.light .dept-card:hover{{box-shadow:0 8px 36px rgba(29,78,216,.14)}}
body.light .dept-head{{border-bottom-color:rgba(29,78,216,.08)}}
body.light .dept-icon{{box-shadow:0 4px 12px rgba(29,78,216,.15)!important}}
body.light .shift-body{{background:rgba(0,0,0,.025)}}
body.light .emp-row:hover{{background:rgba(29,78,216,.05)}}
body.light .emp-row:nth-child(even){{background:rgba(29,78,216,.03)}}
body.light .emp-row:nth-child(even):hover{{background:rgba(29,78,216,.07)}}
body.light .emp-name{{color:#0f172a}}
body.light .s-chip{{
  background:rgba(255,255,255,.88);border-color:rgba(29,78,216,.15);
  box-shadow:0 4px 20px rgba(29,78,216,.1),inset 0 1px 0 rgba(255,255,255,1);
}}
body.light .s-chip:hover{{background:#fff;box-shadow:0 8px 32px rgba(29,78,216,.16)}}
body.light .page-footer{{border-top-color:rgba(29,78,216,.1)}}
body.light .cta-btn{{box-shadow:0 4px 20px rgba(29,78,216,.3),0 0 0 1px rgba(29,78,216,.15)}}
body.light .cta-btn:hover{{box-shadow:0 10px 36px rgba(29,78,216,.4)}}
...
body.light .theme-btn{{background:rgba(29,78,216,.08);border-color:rgba(29,78,216,.18);color:#1d4ed8}}
body.light .theme-btn:hover{{background:rgba(29,78,216,.15)}}
