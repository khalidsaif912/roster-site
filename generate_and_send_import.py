...
.helpModal{width:min(560px,100%);background:rgba(2,6,23,.96);border:1px solid rgba(148,163,184,.25);border-radius:16px;padding:14px 14px 10px;box-shadow:0 16px 50px rgba(0,0,0,.35)}
.helpModal h3{margin:0 0 8px;font-size:16px}
.helpModal ul{margin:0;padding-inline-start:18px;line-height:1.6}
.helpModal .x{float:left;border:none;background:transparent;color:inherit;font-size:20px;cursor:pointer}


.dateTag.today{background:rgba(16,185,129,.14);border:1px solid rgba(16,185,129,.35);box-shadow:none;}
