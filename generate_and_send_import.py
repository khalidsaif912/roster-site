...
def main() -> None:
    ...
    for month_bytes, month_key, month_start_date in [
        ...
        if not sheet:
            ...
            print(f"  ⚠️ No matching sheet for {month_key} — using first sheet: '{sheet}' (قد يكون خاطئاً!)")
