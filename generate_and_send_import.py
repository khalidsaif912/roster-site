...
.bar-btn{{
  height:100%;min-height:52px;width:42px;
  background:rgba(255,255,255,.055);border:1px solid var(--border2);
  border-radius:12px;cursor:pointer;font-size:16px;font-weight:800;
...
(function(){{
  ...
  var hdrW=document.getElementById('hdrWelcome');
  if(empId){{
    ...
    }}).catch(function(){{if(hdrW)hdrW.textContent='\U0001F44B \u0645\u0631\u062d\u0628\u0627\u064b';}});
  }}
