...
/* ─── LIGHT THEME ─── */
body.light{{
  --accent:#1e40af;--accent2:#6d28d9;--green:#065f46;
  --ink:#0f172a;--muted:#334155;--dim:#64748b;
  --border:rgba(0,0,0,.12);--border2:rgba(0,0,0,.18);
  background:#dde3f0;
  background-image:
    radial-gradient(ellipse 70% 50% at 15% 0%,rgba(37,99,235,.2) 0%,transparent 55%),
    radial-gradient(ellipse 50% 40% at 85% 100%,rgba(109,40,217,.14) 0%,transparent 50%);
}}
body.light .header{{
  background:linear-gradient(135deg,#1e3a8a 0%,#1e40af 50%,#1d4ed8 100%);
  border-color:rgba(255,255,255,.15);
  box-shadow:0 8px 32px rgba(30,58,138,.5),0 2px 8px rgba(0,0,0,.3);
}}
...
body.light .dept-card:hover{{
  box-shadow:0 6px 24px rgba(30,64,175,.18),0 2px 6px rgba(0,0,0,.1);
...
body.light .dept-title{{color:#0f172a;font-weight:800}}
body.light .dept-icon{{box-shadow:0 3px 8px rgba(0,0,0,.15)!important}}
body.light .shift-body{{background:#f1f5f9}}
body.light .shift-summary{{filter:brightness(.96)}}
body.light .shift-card{{border:1px solid rgba(0,0,0,.1)!important}}
body.light .shift-card:not([open]) .shift-summary:hover{{filter:brightness(.9)}}
body.light .emp-row{{color:#0f172a}}
body.light .emp-row:hover{{background:rgba(30,64,175,.07)}}
body.light .emp-row:nth-child(even){{background:rgba(0,0,0,.03)}}
body.light .emp-row:nth-child(even):hover{{background:rgba(30,64,175,.08)}}
body.light .emp-name{{color:#0f172a;font-weight:700}}
body.light .emp-code{{color:#1e40af!important}}
body.light .s-chip{{
  background:#ffffff;
  border:1px solid rgba(0,0,0,.15);
  box-shadow:0 2px 10px rgba(0,0,0,.1),0 1px 3px rgba(0,0,0,.07);
  backdrop-filter:none;
}}
...
body.light .s-val.green{{color:#065f46}}
body.light .s-label{{color:#334155;font-weight:700}}
body.light .welcome-name-chip{{color:#334155}}
body.light .page-footer{{
  border-top:1px solid rgba(0,0,0,.12);
  color:#475569;
}}
body.light .page-footer strong{{color:#1e40af!important}}
body.light .cta-btn{{
  background:linear-gradient(135deg,#1e40af 0%,#1e3a8a 100%);
  box-shadow:0 4px 16px rgba(30,64,175,.4),0 1px 4px rgba(0,0,0,.2);
}}
...
body.light .theme-btn{{background:rgba(255,255,255,.2);border-color:rgba(255,255,255,.35);color:#fff}}
body.light .theme-btn:hover{{background:rgba(255,255,255,.32)}}
body.light .lang-btn{{background:rgba(255,255,255,.15);border-color:rgba(255,255,255,.3);color:#fff}}
body.light .lang-btn:hover{{background:rgba(255,255,255,.28)}}
