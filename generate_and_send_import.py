...
<script>
/* ===== Import overrides — must be defined BEFORE export script ===== */
...
(function() {{
  ...
  var currentShift = (hour >= 6 && hour < 14) ? 'Morning' : (hour >= 14 && hour < 22) ? 'Afternoon' : 'Night';
