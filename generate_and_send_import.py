...
body.light .theme-btn{{background:rgba(255,255,255,.18);border-color:rgba(255,255,255,.25);color:#fff}}
body.light .theme-btn:hover{{background:rgba(255,255,255,.3)}}
body.light .lang-btn{{background:rgba(255,255,255,.18);border-color:rgba(255,255,255,.25);color:#fff}}
body.light .lang-btn:hover{{background:rgba(255,255,255,.3)}}
